const BRANCHES = {
  krasnodar: {
    ...
    casesInRegion: 1842,
    totalSaved: '1.2 млрд ₽',
    courts: ['Арбитражный суд Краснодарского края'],
    team: [
  ...
  moscow: {
    ...
    casesInRegion: 4512,
    totalSaved: '5.8 млрд ₽',
    courts: ['Арбитражный суд г. Москвы', 'АС Московской области'],
    team: [
  ...
  kazan: {
    ...
    casesInRegion: 924,
    totalSaved: '430 млн ₽',
    courts: ['Арбитражный суд Республики Татарстан'],
    team: [
  ...
  chita: {
    ...
    casesInRegion: 645,
    totalSaved: '210 млн ₽',
    courts: ['Арбитражный суд Забайкальского края'],
    team: [
